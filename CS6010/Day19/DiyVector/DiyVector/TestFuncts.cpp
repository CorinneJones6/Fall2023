...
void printVector(MyVector<int> inputVector) {
    for (int i =0; i<inputVector.size(); i++){
        std::cout<<inputVector.getValue(i)<<" ";
    }
}
...
void TestMyAlgorithm(){
    ...
    auto count=std::count_if(v1.begin(), v1.end(), isEven);
    std::cout<<"Even sum: "<<count<<"\n";
    
    auto remove=std::remove_if(v1.begin(), v1.end(), isEven);
    v1.popBack();
