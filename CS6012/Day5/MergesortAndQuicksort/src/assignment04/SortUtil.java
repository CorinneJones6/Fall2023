...
public class SortUtil {
     ...
     * @param <T>        the type of elements in the list.
     */
    public static <T> void mergesort(ArrayList<T> array, int start, int end, Comparator<? super T> comparator) {
        int threshold = 20;
    ...
    private static <T> void insertionSort(ArrayList<T> array, Comparator<? super T> comparator) {
        //Index for start and end
        int start = 0;
        int end = array.size() - 1;
     ...
     * @param <T>        the type of elements in the list.
     */
    public static <T> void quicksort(ArrayList<T> array, int startIndex, int endIndex, Comparator<? super T> comparator) {
