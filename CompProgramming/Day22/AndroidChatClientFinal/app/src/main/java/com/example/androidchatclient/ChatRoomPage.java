...
public class ChatRoomPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chatroom_page);
    ...
    public void handleSend(View view){
        // Handle sending a message, called when "send" button is pressed
    ...
    public void handleLeave (View view){
        //Handle leaving, called when "leave" button is pressed
